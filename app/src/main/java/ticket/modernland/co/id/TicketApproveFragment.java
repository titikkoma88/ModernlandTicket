 ...
 */
public class TicketApproveFragment extends Fragment {


    public TicketApproveFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.fragment_ticket_approve, container, false);

        final String id = getArguments().getString("idnya");

        final TextView tIdTiket = (TextView) x.findViewById(R.id.tIdTiketApr);
        final TextView tUser = (TextView) x.findViewById(R.id.tUserApr);
        final TextView tTanggal = (TextView) x.findViewById(R.id.tTanggalApr);
        final TextView tKategori = (TextView) x.findViewById(R.id.tKategoriApr);
        final TextView tSubKategori = (TextView) x.findViewById(R.id.tSubKategoriApr);
        final TextView tDeskripsi = (TextView) x.findViewById(R.id.tDeskripsiApr);
        ...
        Button bApprove = (Button) x.findViewById(R.id.bApproveApr);
        ...
        Button bCancel = (Button) x.findViewById(R.id.bCancelApr);
